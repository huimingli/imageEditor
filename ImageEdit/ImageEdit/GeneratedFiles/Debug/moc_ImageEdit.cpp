...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageEdit_t qt_meta_stringdata_ImageEdit = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ImageEdit"
QT_MOC_LITERAL(1, 10, 4), // "Open"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 4) // "Deal"

    },
    "ImageEdit\0Open\0\0Deal"
};
...
void ImageEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ImageEdit *_t = static_cast<ImageEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ImageEdit::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageEdit.data,
      qt_meta_data_ImageEdit,  qt_static_metacall, nullptr, nullptr}
};
...
void *ImageEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageEdit.stringdata0))
        return static_cast<void*>(const_cast< ImageEdit*>(this));
